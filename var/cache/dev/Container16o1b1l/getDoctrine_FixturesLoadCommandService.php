...
include_once $this->targetDirs[3].'/src/AppBundle/DataFixtures/ORM/LoadDirectors.php';
include_once $this->targetDirs[3].'/src/AppBundle/DataFixtures/ORM/LoadPeople.php';
...
$a->addFixtures(array(0 => new \AppBundle\DataFixtures\ORM\LoadDirectors(), 1 => new \AppBundle\DataFixtures\ORM\LoadPeople()));
