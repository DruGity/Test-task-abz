...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/authorized/workers'), array(0 => 'ROLE_USER'), NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/authorized/search'), array(0 => 'ROLE_USER'), NULL);
